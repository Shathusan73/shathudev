...
const ContactPage = () => {
  ...
  return (
    <>
      <div className="text-center w-full lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[10%]">
        <h2
          data-aos="fade-down"
      ...
      <div
        className="h-auto py-10 flex items-center justify-center w-full px-[10%] "
        id="Contact"
      >
        <div className="container px-[1%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1  gap-12">
          <div
            data-aos="fade-right"
