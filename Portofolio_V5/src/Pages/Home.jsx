...
import { IconCloud } from "../components/IconCloudDemo"
...
const WORDS = ["Project Coordinator", "1+ Years Experience"];
const TECH_STACK = ["React", "Next.js", "Node.js", "Spring Boot", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Shathusan73" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/sritharar-shathusan-17370b252/" },
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[5%] py-[5%] sm:px-6 lg:px-[5%] min-h-screen">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building scalable, innovative full-stack applications with modern technologies. Experienced in coordinating projects and delivering high-quality digital solutions.
                </p>
